(function($) {
  ...
  if (eventCounter.length) {
    eventCounter.countdown('2022/05/17', function(e) {
      $(this).html(e.strftime("<div class='countdown-section'><h2>%D</h2> <h3>Dia%!D</h3> </div><div class='countdown-section'><h2>%H</h2> <h3>Hora%!H</h3> </div><div class='countdown-section'><h2>%M</h2> <h3>Minutos</h3> </div><div class='countdown-section'><h2>%S</h2> <h3>Segundos</h3> </div>"))
    });
  }
  ...
  if ($.fn.meanmenu) {
    $('nav#dropdown').meanmenu({
      siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index.html'><img src='media/logo-mobile.png'  width='45' height='45' alt='logo' class='img-fluid'/></a></div>"
    });
  }
